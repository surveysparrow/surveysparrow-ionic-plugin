...
```typescript
loadFullScreenSurvey(options: { domain: String; token: String; params: Array<Object>; properties: Object; }) => Promise<void>
```

| Param         | Type                                                                                                                                                    |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`options`** | <code>{ domain: <a href="#string">String</a>; token: <a href="#string">String</a>; params: Object[]; properties: <a href="#object">Object</a>; }</code> |
...
```typescript
loadFullScreenSurveyWithValidation(options: { domain: String; token: String; params: Array<Object>; properties: Object; }) => Promise<void>
```
